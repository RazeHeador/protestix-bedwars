...
function CreateEsp(Player)
    ...
    if Player.Character ~= nil and Player.Character:FindFirstChild("Humanoid") ~= nil and Player.Character:FindFirstChild("HumanoidRootPart") ~= nil and Player.Character.Humanoid.Health > 0 and Player.Character:FindFirstChild("Head") ~= nil then
            ...
            if Config.Box then
                ...
                Box.Color = Player.TeamColor.Color --Config.BoxColor
            ...
            if Config.HealthBar then
                ...
                HealthBar.Color = Color3.new(1,0,0):lerp(Color3.new(0,1,0), Player.Character:FindFirstChild("Humanoid").MaxHealth/Player.Character:FindFirstChild("Humanoid").Health)
                ...
                if Config.HealthBarSide == "Left" then
                    ...
                    HealthBar.Size = Vector2.new(3,-(HealthBarOutline.Size.Y - 2) * (Player.Character:FindFirstChild("Humanoid").Health/Player.Character:FindFirstChild("Humanoid").MaxHealth))
                ...
                elseif Config.HealthBarSide == "Bottom" then
                    ...
                    HealthBar.Size = Vector2.new((HealthBarOutline.Size.X - 2) * (Player.Character:FindFirstChild("Humanoid").Health/Player.Character:FindFirstChild("Humanoid").MaxHealth),3)
                    HealthBar.Position = HealthBarOutline.Position + Vector2.new(1,-1 + HealthBarOutline.Size.Y)
